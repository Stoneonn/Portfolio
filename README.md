<img src="/web/public/cover.jpg" alt="Cover image representing Nim, a personal website template" width="100%" />
...
This repository is organized with the Next.js application in the `web` subdirectory, allowing you to add other unrelated files or projects to the root directory without affecting the build process.
...
**Important:** When deploying to Vercel, set the **Root Directory** to `web` in your project settings (Settings → General → Root Directory).
